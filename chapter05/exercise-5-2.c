 ...
 *
 * Reads the next number from input, and puts it into *fp.
 * Returns EOF for end of file, zero if the next input is 
 * not a nmber, and a positive value of the input contains
 * a valid number.
 *
